...
<style type="text/css">
  ...
  <body >
  <div>
  <img src="resource/img/greenTea1.jpg" style="width:100%;display: block;"/>
  </div>
  <div>
  <img src="resource/img/greenTea2.jpg" style="width:100%;display:block;"/>
  <a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6a3d881182f88c74&redirect_uri=http%3A%2F%2Fweidian.com%2Fp5%2Fshop%2Fpages%2Fitem-new.php%3FitemID%3D1744593013%26p%3D-1&response_type=code&scope=snsapi_base&state=H5WXshare&from=singlemessage&isappinstalled=0#wechat_redirect"><img src="resource/img/blackTea2btn.png" style="width:30%; margin:-15% 35% 3%;display:block;">
  </a>
  </div>
  <div>
  <img src="resource/img/greenTea3.jpg" style="width:100%;display:block;"/>
